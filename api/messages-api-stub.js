(function () {
        ...
        makeChatPreviews(chatNames, allChatsMessages) {
            ...
            for (const chat of chatNames) {
                ...
                if (chatMessages == null || chatMessages.length === 0) {
                    ...
                    const lastMessage = document.utils.maxBy(chatMessages, msgs => msgs.date, (a, b) => b.getTime() - a.getTime());
                    const preview = {
                        id: chat.id,
                        title: chat.title,
    ...
    if (document.api == null) {
        document.api = {}
    }

    document.api.chatApiStub = new ChatApiStub();
})()